...
venue: "HU Berlin"        # brief name of the institution that hosts the workshop without address (e.g., "Euphoric State University")
...
longitude: "13"       # decimal longitude of the workshop venue (use https://www.latlong.net)
